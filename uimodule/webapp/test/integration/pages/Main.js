sap.ui.require(["sap/ui/test/Opa5", "sap/ui/test/actions/Press"], function (Opa5, Press) {
    ...
    Opa5.createPageObjects({
        onTheMainPage: {
            viewName: "sap.ui.demo.mockserver.view.MainView",
            ...
            assertions: {
                ...
                iShouldSeeTheTitle: function () {
                    return this.waitFor({
                        ...
                        properties: {
                            text: "Title of sap.ui.demo.mockserver",
                        },
                        success: function () {
                            Opa5.assert.ok(true, "The page shows the correct title");
                        },
                        errorMessage: "App does not show the expected title sap.ui.demo.mockserver",
                    });
                },
            },
        },
